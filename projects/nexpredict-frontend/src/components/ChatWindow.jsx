...
export default function ChatWindow({ onClose }) {
  const [messages, setMessages] = useState([
    {
      id: 1,
      text: "Hi! I'm your NexPredict assistant. How can I help you today?",
      sender: 'bot',
      timestamp: new Date()
    }
  ]);
  ...
  const getBotResponse = (userMessage) => {
    ...
    if (lowerMessage.includes('create') || lowerMessage.includes('prediction')) {
      ...
      return "Hello! Welcome to NexPredict! I'm here to help you with predictions, betting, and rewards. What would you like to know?";
      ...
      return "NexPredict runs on Algorand TestNet. Make sure your wallet is connected to TestNet and you have some TestNet ALGO for transactions!";
    } else {
      ...
      >
        ...
        <div className="bg-gradient-to-r from-blue-500 to-purple-600 p-4 flex items-center justify-between">
          <div className="flex items-center gap-3">
            ...
            <div>
              <h3 className="font-bold text-white">NexPredict Assistant</h3>
