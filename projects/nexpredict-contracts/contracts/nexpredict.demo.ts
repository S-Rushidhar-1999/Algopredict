...
import { NexPredictClient } from './clients/NexPredictClient';
...
const getNextPredictionIndex = async (Caller: NexPredictClient) => {
...
const getPrediction = async (Caller: NexPredictClient, index: number) => {
...
const getUserPrediction = async (Caller: NexPredictClient, user: string, index: number) => {
...
(async () => {
  ...
  const Caller = new NexPredictClient(
    {
      sender: admin,
      resolveBy: 'id',
      id: 727094749,
